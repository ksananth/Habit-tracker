...
import '../../features/dashboard/usecase/sort_habit_usecase.dart';
...
Future<void> configureDependencies() async {
  ...
  getIt.registerLazySingleton<SortHabitUseCase>(
        () => SortHabitUseCase(getIt<HabitRepository>()),
  );
  ...
  getIt.registerLazySingleton<DashboardBloc>(
        () => DashboardBloc(getIt<GetDashboardUseCase>(), getIt<SortHabitUseCase>()),
  );
